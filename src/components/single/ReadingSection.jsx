        ...
        <button onClick={handleVote} disabled={disabledBtn}>
          {!activeBtn || activeBtn === "none" ? (
            <span className="neutral">
              {" "}
              <IoMdThumbsUp /> {article.votes} <IoMdThumbsDown />{" "}
            </span>
          ) : (
            ""
          )}
          {activeBtn === "like" ? (
            <span className="like-active">
              {" "}
              Upvoted <IoMdThumbsUp fill="#0e8542" /> {article.votes}{" "}
            </span>
          ) : (
            ""
          )}
          {activeBtn === "dislike" ? (
            <span className="dislike-active">
              {" "}
              Downvoted <IoMdThumbsDown fill="#FF0063" /> {article.votes}{" "}
            </span>
          ) : (
            ""
          )}
